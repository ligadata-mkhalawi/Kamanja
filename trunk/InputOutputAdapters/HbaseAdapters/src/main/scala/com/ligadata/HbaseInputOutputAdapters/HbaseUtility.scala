...
import com.ligadata.keyvaluestore.{HBaseAdapter, KeyValueManager}
...
//  }
  ...
  def getData(): org.apache.hadoop.hbase.client.Result ={
    try {
      relogin()
...
//  }
//
//  private def getRowSize(r: org.apache.hadoop.hbase.client.Result) : Int = {
...
//            updateObjStats("put",fulltableName,puts.length)
//            updateByteStats("put",fulltableName,byteCount)
//          }
//        } catch {
//          case e: Exception => {
//          //  externalizeExceptionEvent(e)
...
//      case e: Exception => {
//     //   externalizeExceptionEvent(e)
//        throw new KamanjaException("Failed to save a list of objects in table(s) ", e)
//      }
//    } finally {
//      if (tableHBase != null) {
//        tableHBase.close()
