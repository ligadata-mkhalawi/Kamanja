...
/**
  *
  */
class TestJython7 extends FunSuite with BeforeAndAfter {
  ...
  test("test1") {
    ...
    try {
      ...
      val msg1_class  = cl1.loadClass("com.ligadata.kamanja.samples.messages.msg1").getConstructor(classOf[MessageFactoryInterface]).newInstance(null)
      var msg1 = msg1_class.asInstanceOf[com.ligadata.KamanjaBase.BaseMsg]
      msg1.set(0, 111)
      msg1.set(1, "<test>")
      msg1.set(2, 99)
      val msgset = Array[PyObject](Py.java2py(msg1))
      val args = Array[PyObject](Py.java2py(null), Py.java2py(msgset), Py.java2py(0), Py.java2py(true))
      val r: PyObject = modelObject.invoke("execute", args)

      // Convert output back to object
      val outmsg: com.ligadata.KamanjaBase.BaseMsg = r.__tojava__(classOf[com.ligadata.KamanjaBase.BaseMsg]).asInstanceOf[com.ligadata.KamanjaBase.BaseMsg]

      logger.Info("Result:" + outmsg.get(0).asInstanceOf[Int].toString + " " + outmsg.get(1).asInstanceOf[String])
