...
/**
  *
  */
class ErrorContextTest extends FunSuite with BeforeAndAfter {
  ...
  test("test1") {
    ...
    val fileInput = getClass.getResource("/errorcontext/error001.jtm").getPath
    val fileOutput = getClass.getResource("/errorcontext/").getPath + "/error001.scala.actual"
    val fileExpected = getClass.getResource("/errorcontext/error001.scala.expected").getPath
