...
/**
  *
  */
class CodeTest extends FunSuite with BeforeAndAfter {
  ...
  test("test1") {
    ...
    val fileInput = getClass.getResource("/code/code001.jtm").getPath
    val fileOutput = getClass.getResource("/code/").getPath + "/code001.scala.actual"
    val fileExpected = getClass.getResource("/code/code001.scala.expected").getPath
