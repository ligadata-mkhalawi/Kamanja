...
*/
  ...
  def put(containerName: String, keyFields: Array[String], fieldValues: scala.collection.mutable.Map[String, String]): Unit = {
    throw new KamanjaException("Not a valid operation for this adapter", null)
  }

  def get(containerName: String, selectList: Array[String], filterMap:scala.collection.mutable.Map[String, String], keyFields: Array[String], callbackFunction: (String, String, String) => Unit): Unit = {
    throw new KamanjaException("Not a valid operation for this adapter", null)
  }
}
