...
java -Dlog4j.configurationFile=file:$kamanjaHome/config/log4j2.xml -cp $kamanjaHome/lib/system/ExtDependencyLibs2_2.10-1.5.1.jar:$kamanjaHome/lib/system/ExtDependencyLibs_2.10-1.5.1.jar:$kamanjaHome/lib/system/KamanjaInternalDeps_2.10-1.5.1.jar:$kamanjaHome/lib/system/generateadapterbindings_2.10-1.5.1.jar com.ligadata.Migrate.GenerateAdapterBindings --config $clusterConfig --outfile $outputFile
echo result = $?
