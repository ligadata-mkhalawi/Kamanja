...
echo ExtDependencyLibs_2.10-1.5.1.jar > $installPath/Kamanja-$ver210/config/library_list
echo KamanjaInternalDeps_2.10-1.5.1.jar >> $installPath/Kamanja-$ver210/config/library_list
echo ExtDependencyLibs2_2.10-1.5.1.jar >> $installPath/Kamanja-$ver210/config/library_list
...
echo ExtDependencyLibs_2.11-1.5.1.jar > $installPath/Kamanja-$ver211/config/library_list
echo KamanjaInternalDeps_2.11-1.5.1.jar >> $installPath/Kamanja-$ver211/config/library_list
echo ExtDependencyLibs2_2.11-1.5.1.jar >> $installPath/Kamanja-$ver211/config/library_list
