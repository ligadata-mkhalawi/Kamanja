...
cp $HOME/.ivy2/cache/commons-pool/commons-pool/jars/commons-pool-1.6.0.jar $KAMANJALIBPATH
...
cp $HOME/.ivy2/cache/org.apache.commons/commons-compress/jars/commons-compress-1.6.0.jar $KAMANJALIBPATH
