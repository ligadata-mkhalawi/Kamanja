...
object ModelService {
   ...
   * @return the result of the operation
   */
  def addModelJava(input: String, dep: String = "", userid: Option[String] = Some("kamanja"), optMsgProduced: Option[String] = None, tid: Option[String] = None): String = {
    var modelDefs = Array[String]()
    var modelConfig = ""
    var modelDef = ""
    var response: String = ""
      ...
      finalTid = tid
        ...
        val response : String = if (input == "") {
            ...
            val resp : String = if(model.exists()){
                ...
                MetadataAPIImpl.AddModel(ModelType.PMML, modelDef, optUserid, finalTid,  optModelName, optVersion, optMsgConsumed,optMsgVersion,pStr, optMsgProduced)
            }else{
   ...
   * @return result string from engine describing success or failure
   */
  def addModelPython(modelType: ModelType.ModelType, input: String, optUserid: Option[String] = Some("kamanja"), optModelName: Option[String] = None, optVersion: Option[String] = None, optMsgConsumed: Option[String] = None, optMsgVersion: Option[String] = Some("-1"), tid: Option[String] = None): String = {
   ...
   * @return the result of the operation
   */
  def addModelJTM(input: String, userid: Option[String] = Some("kamanja"), tid: Option[String] = None, optModelName: Option[String] = None): String = {
    var modelDef = ""
    var response: String = ""
    var modelFileDir: String = ""
  ...
  def updateModelKPmml(input: String, userid: Option[String] = Some("kamanja"), tid: Option[String] = None): String = {
    var modelDef = ""
    var response: String = ""
    var modelFileDir: String = ""
    //val gitMsgFile = "https://raw.githubusercontent.com/ligadata-dhaval/Kamanja/master/HelloWorld_Msg_Def.json"
  ...
  def updateModelJTM(input: String, userid: Option[String] = Some("kamanja"), tid: Option[String] = None, optModelName: Option[String] = None): String = {
    var modelDef = ""
    var response: String = ""
    var modelFileDir: String = ""
    var chosen: String = ""
  ...
  def updateModelPmml(pmmlPath : String
    ...
    val response: String = try {
      ...
      MetadataAPIImpl.UpdateModel(ModelType.PMML, pmmlText, userid, finalTid, Some(modelNamespaceName), Some(newVersion), None, None)
    } catch {
   ...
   * @return result string
   */
  def updateModelPython(pythonModelPath: String, userid: Option[String], modelNamespaceName: String, newVersion: String, tid: Option[String] = None): String = {
   ...
   * @return result string
   */
  def updateModelJython(jythonModelPath: String, userid: Option[String], modelNamespaceName: String, newVersion: String, tid: Option[String] = None): String = {
   ...
   * @return the result of the operation
   */
  def activateModel(modelId: String = "", userid: Option[String] = Some("kamanja")): String = {
    var response = ""
    try {
      if (modelId.length > 0) {
        val (ns, name, ver) = com.ligadata.kamanja.metadata.Utils.parseNameToken(modelId)
