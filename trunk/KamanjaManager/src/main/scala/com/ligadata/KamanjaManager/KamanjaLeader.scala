...
object KamanjaLeader {
  ...
  private[this] var distributionExecutor = Executors.newFixedThreadPool(1, com.ligadata.Utils.Utils.GetScalaThreadFactory("Class:" + getClass.getName + "-distributionExecutor-%d"))
  ...
  def Reset: Unit = {
    ...
    distributionExecutor = Executors.newFixedThreadPool(1, com.ligadata.Utils.Utils.GetScalaThreadFactory("Class:" + getClass.getName + "-distributionExecutor-%d"))
  }
...
*/
  ...
  */
  ...
  def PostAdapterParitionInfoToLocalDrive(): Unit = synchronized {
    ...
    execCtxtsAdapterInfoPool = scala.actors.threadpool.Executors.newFixedThreadPool(2, com.ligadata.Utils.Utils.GetScalaThreadFactory("Class:" + getClass.getName + "-execCtxtsAdapterInfoPool-%d"))
