 ...
 * Example:
 *
 *  setPathsFor.scala --installDir /tmp/drdigital/KamanjaInstall-1.5.1_2.11 --templateFile ClusterConfig.1.5.1.json --scalaHome `which scala` --javaHome `which java` >/tmp/clusterconfig.json 
 *
