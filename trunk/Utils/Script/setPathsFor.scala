 ...
 * Example:
 *
 *  setPathsFor.scala --installDir /tmp/drdigital/KamanjaInstall-2.11 --templateFile ClusterConfig.json --scalaHome `which scala` --javaHome `which java` >/tmp/clusterconfig.json 
 *
