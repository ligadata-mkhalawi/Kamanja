...
lazy val OrientDBScalabilityTesting = project.in(file("Utils/OrientDBScalabilityTesting")).configs(TestConfigs.all: _*).settings(TestSettings.settings: _*).dependsOn(ExtDependencyLibs % "provided", ExtDependencyLibs2 % "provided", Exceptions)
